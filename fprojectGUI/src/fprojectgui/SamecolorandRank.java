...
public class SamecolorandRank implements Playingstratagy {

    Timer time;

    @Override
    public void play(int i) {
        if ((mycardframe.color.equals(mycardframe.color2) && mycardframe.rank == mycardframe.rank2)||(mycardframe.color.equals("joker")&&mycardframe.color2.equals("joker"))) {
