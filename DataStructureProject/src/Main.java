...
//////Add
    ...
    heap.list[index+1]=new Employee(Integer.parseInt(idField.getText()),firstNameField.getText(),lastNameField.getText(),(String)statusBox.getSelectedItem(),Integer.parseInt(salaryDouble));
...
/////delete
	...
	if(!firstNameField.equals("")&&!lastNameField.equals("")&&!idField.equals("")&&(statusBox.getSelectedIndex()!=-1)&&(salaryBox.getSelectedIndex()!=-1))
	{
       ...
       heap.insert(new Employee(Integer.parseInt(idField.getText()),firstNameField.getText(),lastNameField.getText(),(String)statusBox.getSelectedItem(),Integer.parseInt(salaryDouble)));
